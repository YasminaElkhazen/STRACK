...
cred = credentials.Certificate("atelliteServer\\service.json")
...
def login():
    ...
    try:
        ...
        response = requests.post("https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=credentials.get("api")",
...
def get_satellite_positions():
    try:
        ...
        url = f'https://api.n2yo.com/rest/v1/satellite/positions/{satellite_id}/41.702/-76.014/0/2/&apiKey=credentials.get("apii")'
