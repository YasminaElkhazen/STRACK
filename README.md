My end of year project, a simple satellite tracking web application offering the possibility to browse hundreds of satellites as well as tracking their positions real-time.
Config:
1.auth 
